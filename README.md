...
**Systems Programming**
- High-performance implementation in **C**, **Rust**, and **Zig**.
- Deep understanding of Linux internals, syscalls, and memory management.
- Development of lightweight, robust system utilities.

**Frontend Development (The Suckless Approach)**
- Eschewing heavy frameworks (React/Next.js) in favor of **Raw DOM manipulation**.
- High-performance **Vanilla JavaScript** and optimized CSS.
...
- Automation and configuration via **Lua** scripting.
- Infrastructure as code with an emphasis on minimalist tooling.

### Current Research and Focus
- **Zig:** Mastering the language for production-ready systems.
- **Linux Internals:** Deep-dive into kernel-space development and subsystem optimization.
